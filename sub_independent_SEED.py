...
#
def sub_independent_on_SEED(result_dir, dirname, regular_str, cross_validate):
    # load data and resort.
    data, labels = utils.utils.load_SEED_independent(dirname, regular_str)
...
if __name__ == "__main__":
    ...
    result_list = sub_independent_on_SEED(result_dir, dirname, regular_str, cross_validate)
    print(result_list)
